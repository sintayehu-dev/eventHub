...
class _StaffAssignmentWidgetState extends State<StaffAssignmentWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _buildStaffSelectionDropdown(context),
        SizedBox(height: 16.h),
        ...
        if (_selectedStaffIds.isNotEmpty) ...[
          ...
          ..._selectedStaffIds.map((staffId) {
            ...
            return Padding(
              ...
              child: _buildSelectedStaffCard(context, staff),
            );
          }),
        ],
      ],
  ...
  Widget _buildStaffSelectionDropdown(BuildContext context) {
    if (_isLoadingStaff) {
      return Container(
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildStaffCheckboxItem(context, staff, isSelected);
                },
              ),
            ),
          ],
